...
namespace TechChallenge.Controllers
{
    public class EquipesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,DataCriacao,Ativa")] Equipe equipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,DataCriacao,Ativa")] Equipe equipe)
        {
            if (id != equipe.Id)
            {
                return NotFound();
